...
Инструменты(библиотеки): pandas, numpy, scipy.stats (для статистического анализа), seaborn, plotly, matplotlib, os(для поиска и парсинга файлов из папки)<br>
Язык запросов: SQL<br>
Инструменты: Redash, ClikcHouse<br>
